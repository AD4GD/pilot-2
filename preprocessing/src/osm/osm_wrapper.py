...
class OSMWrapper():
    ...
    def osm_to_geojson(self, years:list):
        """
        ...
        """
        osmp = OSMPreprocessor(self.config, self.osm_output_data_dir, self.verbose, years)
        for year in years:
            ...
            osmp.convert_to_geojson(queries=queries)
...
if __name__ == "__main__":
    ...
    years = osm.osm_to_geojson(True)
    osm.osm_to_merged_gpkg(years)
    osm.delete_temp_files()
