...
# to filter columns in the geodataframe
filtered_columns = ['geometry','name','natural','water','height']  # specify columns needed
...
# to filter columns in the geodataframe
filtered_columns = ['geometry','name','frequency','bridge','maxspeed','level','gauge']  # specify columns needed
...
# 5. to merge all geopackages into one (to be fixed or deleted as single geopackages can be also consumed by further preproprocessing steps)
